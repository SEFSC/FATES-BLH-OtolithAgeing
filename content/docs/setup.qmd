...
:::{.callout-note}
The instructions on this page only need to be carried out once. If you have aleady installed the required dependencies and created a virtual environment, skip ahead to [Using the Model](usage.qmd).
:::
...
If needed, download and install the [Git CLI](https://git-scm.com/downloads) before continuing. This does not need administrative priviledges to install at the user level. Confirm that it has been installed by opening a command line terminal and entering `git --version`.
