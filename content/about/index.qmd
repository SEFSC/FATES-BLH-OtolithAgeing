...
Instructions for creating an actual documentation page using the theme are provided in [Getting started with SEFSC Quarto Documentation Theme Skeleton]({{< meta website.repo-url >}}/content/howto/setup.html).