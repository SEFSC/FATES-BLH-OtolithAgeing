...
| `preprocessed_image_path` | Path to save the processed images |  Best to include the full path in quotations and to use a dedicated folder. Example: "G:/Shared drives/NMFS SEFSC FATES Advanced Technology/BIOLOGY_LIFE_HISTORY_DATA/age_testing/cropped" |
...
:Segment Anything Model (SAM) parameters {tbl-colwidths="[20,30,50]"}
...
:Cropping and padding parameters {tbl-colwidths="[20,30,50]"}
...
:Image normalization options {tbl-colwidths="[20,30,50]"}
...
:Configuration for age inference model {tbl-colwidths="[20,30,50]"}
